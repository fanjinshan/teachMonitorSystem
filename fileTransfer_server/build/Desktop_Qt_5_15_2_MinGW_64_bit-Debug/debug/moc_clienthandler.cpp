...
QT_MOC_LITERAL(8, 78, 20), // "studentStatusChanged"
QT_MOC_LITERAL(9, 99, 9), // "studentId"
QT_MOC_LITERAL(10, 109, 13), // "StudentStatus"
QT_MOC_LITERAL(11, 123, 6), // "status"
QT_MOC_LITERAL(12, 130, 7), // "appName"
QT_MOC_LITERAL(13, 138, 10), // "screenshot"
QT_MOC_LITERAL(14, 149, 17), // "heartbeatReceived"
QT_MOC_LITERAL(15, 167, 11), // "onReadyRead"
QT_MOC_LITERAL(16, 179, 14), // "onDisconnected"
QT_MOC_LITERAL(17, 194, 15), // "onErrorOccurred"
QT_MOC_LITERAL(18, 210, 28), // "QAbstractSocket::SocketError"
QT_MOC_LITERAL(19, 239, 11) // "socketError"

    },
    "ClientHandler\0disconnected\0\0logMessage\0"
    "message\0fileReceived\0fileName\0fileSize\0"
    "studentStatusChanged\0studentId\0"
    "StudentStatus\0status\0appName\0screenshot\0"
    "heartbeatReceived\0onReadyRead\0"
...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->studentStatusChanged((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< StudentStatus(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3])),(*reinterpret_cast< const QByteArray(*)>(_a[4]))); break;
        case 4: _t->heartbeatReceived((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ClientHandler::*)(const QString & , StudentStatus , const QString & , const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientHandler::studentStatusChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (ClientHandler::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientHandler::heartbeatReceived)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 3
void ClientHandler::studentStatusChanged(const QString & _t1, StudentStatus _t2, const QString & _t3, const QByteArray & _t4)
{
...
// SIGNAL 4
void ClientHandler::heartbeatReceived(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
